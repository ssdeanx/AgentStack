...
export const openRouterModels = {
    ...
    deepseekR1DistillLlama70b: openrouter(
    ...
    metaLlama3370bInstructFree: openrouter(
    ...
    metaLlama3211bVisionInstruct: openrouter(
    ...
    qwenQwen25Vl72bInstructFree: openrouter(
    ...
    mistralMistralSmall32Free: openrouter(
