...
const coordinationPrompts = [
    ...
    },
    {
        ...
        description:
            'Content creation pipeline: research → write → edit → evaluate',
        version: '1.0.0',
    },
    {
        name: 'rag-query',
    ...
    },
    {
        ...
        description:
            'Coordinate multi-agent research with knowledge extraction',
        version: '1.0.0',
    },
    {
        name: 'coding-feature-development',
        description:
            'Full feature development: architecture → implementation → review → testing',
        version: '1.0.0',
    },
    {
...
const agentResources = [
    {
        ...
        description:
            'Metadata about the A2A Coordinator Agent including capabilities',
    },
    {
...
export const a2aCoordinatorMcpServer = new MCPServer({
    ...
    version: '1.0.0',
    description:
        'Exposes the A2A Coordinator Agent for multi-agent orchestration via MCP and A2A protocols',
    ...
    prompts: {
        ...
        getPromptMessages: async ({ name, version, args }) => {
            let prompt = coordinationPrompts.find(
            ...
            return [
                {
                    ...
                    content: {
                        type: 'text',
                        text: `Execute coordination task: ${args?.task ?? 'coordinate agents'}`,
                    },
                },
            ]
        },
...
const codingPrompts = [
    {
        ...
        description:
            'Complete feature development: architecture → implementation → review → testing',
        version: '1.0.0',
    },
    {
        name: 'comprehensive-code-review',
        description:
            'Multi-agent code review: architecture + quality + security + testing',
        version: '1.0.0',
    },
    {
        name: 'safe-refactoring-with-tests',
        description:
            'Refactor code safely with sandbox verification and test generation',
        version: '1.0.0',
    },
    {
        name: 'sandbox-code-execution',
        description:
            'Execute and test code in isolated E2B sandbox environment',
        version: '1.0.0',
    },
    {
...
export const codingA2AMcpServer = new MCPServer({
    ...
    version: '1.0.0',
    description:
        'Exposes the Coding A2A Coordinator for multi-agent coding workflows via MCP and A2A protocols',
    releaseDate: '2025-10-18',
    isLatest: true,
    packageCanonical: 'npm',
    packages: [],
            ...
            return [
                {
                    ...
                    content: {
                        type: 'text',
                        text: `Execute coding coordination task: ${args?.task ?? 'coordinate coding agents'}`,
                    },
                },
            ]
        },
