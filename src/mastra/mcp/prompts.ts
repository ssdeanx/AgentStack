...
const prompts = [
    {
        name: 'new_note',
        description:
            'Create a new note, that can be used for brainstorming ideas, organizing thoughts, or capturing information. This note can be easily edited and shared with others. It can also be used to keep track of tasks or projects. You can also use it to create a to-do list or a project plan. You can also use it to create a to-do list or a project plan.',
        version: '1.0.1',
    },
    {
        name: 'summarize_note',
        description:
            'Give me a TL;DR of the note. This can be useful for quickly understanding the main points of a note.',
        version: '1.0.1',
    },
    {
        name: 'brainstorm_ideas',
        description:
            'Brainstorm new ideas based on a note. This can be useful for generating new ideas or solutions to problems.',
        version: '1.0.1',
    },
]
...
const getPromptMessages: MCPServerPrompts['getPromptMessages'] = async ({
    ...
    switch (name) {
        ...
        default:
            throw new Error(
                `Prompt \\"${name}\\" not found, please check the prompt name and try again.`
            )
    }
}
