...
export const readDataFileTool = createTool({
    ...
    execute: async (input, context) => {
        ...
        await writer?.custom({
            ...
            data: {
                status: 'in-progress',
                message: '📖 Reading file: ' + input.fileName,
                stage: 'read:file',
            },
            id: 'read:file',
        })
...
export const writeDataFileTool = createTool({
    ...
    execute: async (input, context) => {
        ...
        await writer?.custom({
            ...
            data: {
                status: 'in-progress',
                message: '💾 Writing to file: ' + input.fileName,
                stage: 'write:file',
            },
            id: 'write:file',
        })
...
export const deleteDataFileTool = createTool({
    ...
    execute: async (input, context) => {
        ...
        await writer?.custom({
            ...
            data: {
                status: 'in-progress',
                message: '🗑️ Deleting file: ' + input.fileName,
                stage: 'delete:file',
            },
            id: 'delete:file',
        })
    ...
    execute: async (input, context) => {
        ...
        await writer?.custom({
            ...
            data: {
                status: 'in-progress',
                message:
                    '📂 Listing directory: ' + (input.dirPath ?? 'docs/data'),
...
export const copyDataFileTool = createTool({
    ...
    execute: async (input, context) => {
        ...
        await writer?.custom({
            ...
            data: {
                status: 'in-progress',
                message: `📋 Copying file: ${input.sourceFile} to ${input.destFile}`,
                stage: 'copy:file',
            },
            id: 'copy:file',
        })
...
export const moveDataFileTool = createTool({
    ...
    execute: async (input, context) => {
        ...
        await writer?.custom({
            ...
            data: {
                status: 'in-progress',
                message: `🚚 Moving file: ${input.sourceFile} to ${input.destFile}`,
                stage: 'move:file',
            },
            id: 'move:file',
        })
...
export const searchDataFilesTool = createTool({
    ...
    execute: async (input, context) => {
        ...
        await writer?.custom({
            ...
            data: {
                status: 'in-progress',
                message: `🔍 Searching for pattern: "${input.pattern}"`,
                stage: 'search:files',
            },
            id: 'search:files',
        })
...
export const getDataFileInfoTool = createTool({
    ...
    execute: async (input, context) => {
        ...
        await writer?.custom({
            ...
            data: {
                status: 'in-progress',
                message: 'ℹ️ Getting info for file: ' + input.fileName,
                stage: 'get:fileinfo',
            },
            id: 'get:fileinfo',
        })
...
export const createDataDirTool = createTool({
    ...
    execute: async (input, context) => {
        ...
        await writer?.custom({
            ...
            data: {
                status: 'in-progress',
                message: '📁 Creating directory: ' + input.dirPath,
...
export const removeDataDirTool = createTool({
    ...
    execute: async (input, context) => {
        ...
        await writer?.custom({
            ...
            data: {
                status: 'in-progress',
                message: '🗑️ Removing directory: ' + input.dirPath,
...
export const archiveDataTool = createTool({
    ...
    execute: async (input, context) => {
        ...
        await writer?.custom({
            ...
            data: {
                status: 'in-progress',
                message: `📦 Archiving: ${input.sourcePath} to ${input.archiveName}.gz`,
                stage: 'archive:data',
            },
            id: 'archive:data',
        })
...
export const backupDataTool = createTool({
    ...
    execute: async (input, context) => {
        ...
        await writer?.custom({
            ...
            data: {
                status: 'in-progress',
                message: `💾 Creating backup for: ${input.sourcePath}`,
                stage: 'backup:data',
            },
            id: 'backup:data',
        })
