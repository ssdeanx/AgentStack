...
export function ArxivPaperCard({
    input,
    output,
    errorText,
}: ToolProps<any, any>) {
                ...
                <ScrollArea className="h-[350px] pr-4">
                    <div className="space-y-4">
                        {results.map((result: any, idx: number) => (
                            <div
                                key={`${result.link}-${idx}`}
                                className="flex flex-col gap-1 p-3 border rounded-lg hover:bg-muted/50 transition-colors"
                            >
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-sm font-semibold text-blue-600 dark:text-blue-400 hover:underline leading-tight"
                                >
                                    {result.title}
                                </a>
