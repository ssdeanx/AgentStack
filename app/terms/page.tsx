        ...
        <div className="container mx-auto max-w-4xl px-4 py-24">
            ...
            <div className="prose dark:prose-invert">
                ...
                <p>
                    ...
                    the materials (information or software) on AgentStack's
                ...
                <ul>
                    ...
                    <li>
                        ...
                        contained on AgentStack's website;
                    </li>
                </ul>
                <h2>3. Disclaimer</h2>
                <p>
                    The materials on AgentStack's website are provided on an 'as
                    is' basis. AgentStack makes no warranties, expressed or
