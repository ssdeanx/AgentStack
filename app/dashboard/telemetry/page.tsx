                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">
                                {Number(
                                    (
                                        telemetry as unknown as Record<
                                            string,
                                            unknown
                                        >
                                    )?.total ??
            ...
            >
                <div className="flex items-start justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        {entry.duration && (
                            <Badge variant="outline">{entry.duration}ms</Badge>
                        )}
                        {entry.status && (
                            <Badge
                                variant={
...
function calculateAvgDuration(telemetry: any): string {
    const items = Array.isArray(telemetry)
        ? telemetry
        : (telemetry?.traces ?? [])
    if (!items.length) {
        return 'N/A'
