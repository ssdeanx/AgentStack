...
function IndexDetails({
    ...
    const {
        ...
        loading,
        error,
    } = useVectorDetails(vectorStore, indexName)
    const {
        query,
        loading: querying,
        error: queryError,
                ...
                >
                    ...
                    <DialogContent>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Are you sure you want to delete "{indexName}"?
