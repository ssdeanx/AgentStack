...
<ApiEndpoint
    ...
    description="Get a specific agent's details"
/>
```
...
<ApiEndpoint
    ...
    description="Generate a response from an agent (non-streaming)"
/>
```
...
<ApiEndpoint
    ...
    description="Open a streaming session with the agent"
/>
```
...
<ApiEndpoint
    ...
    description="Execute a specific tool within the context of an agent"
/>
```
...
<ApiEndpoint
    method="POST"
    path="/api/agents/{agentId}/instructions"
    description="Update instruction sets for an agent"
/>
```
...
<ApiEndpoint
    ...
    description="Automatic enhancement of instructions"
/>
```
...
<ApiEndpoint
    ...
    description="Approve a tool call requested by an agent"
/>
```
...
<ApiEndpoint
    ...
    description="Decline a tool call requested by an agent"
/>
```
...
const resp = await fetch(
    'http://localhost:4111/api/agents/hello-world-agent/generate',
    {
        method: 'POST',
        headers: {
