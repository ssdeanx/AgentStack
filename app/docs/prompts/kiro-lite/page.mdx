...
name: 'Kiro-Lite'
title: 'Kiro‑Lite'
description: 'Kiro‑Lite — a spec-driven Copilot Chat assistant for GitHub Copilot. Automates research, spec drafting, confirmation, and iterative implementation. Includes memory bank, prompts, and automatic validation hooks.'
agent: 'agent'
