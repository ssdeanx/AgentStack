        ...
        agents: [
            {
                ...
                name: 'Data Ingestion',
                description: 'CSV parsing and file reading',
                role: 'ingestion',
            },
            {
                id: 'dataTransformationAgent',
                name: 'Data Transformation',
                description: 'CSV↔JSON↔XML transforms',
                role: 'transform',
            },
            {
                id: 'dataExportAgent',
                name: 'Data Export',
                description: 'File writing and backup',
                role: 'export',
            },
        ],
    },
    'report-generation-network': {
        ...
        agents: [
            ...
            },
            {
                ...
                description: 'Analyze and score content',
                role: 'analysis',
            },
            {
                id: 'reportAgent',
    ...
    'research-pipeline-network': {
        ...
        agents: [
            ...
            },
            {
                ...
                description: 'ArXiv search and PDF parsing',
                role: 'papers',
            },
            {
...
export function getNetworksByCategory(): Record<
    NetworkCategory,
    NetworkConfig[]
> {
