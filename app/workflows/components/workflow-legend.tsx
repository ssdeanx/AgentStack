...
export function WorkflowLegend() {
    ...
    return (
        <Panel
            position="top-right"
            className="p-0 mt-20 bg-card/40 backdrop-blur-3xl border-border/20 shadow-2xl rounded-2xl overflow-hidden min-w-40 transition-all duration-300 hover:border-primary/30 group"
        >
            <Collapsible open={isOpen} onOpenChange={setIsOpen}>
                <CollapsibleTrigger asChild>
                    <Button
                        variant="ghost"
                        size="sm"
                        className="h-10 gap-3 px-4 text-[10px] font-bold uppercase tracking-[0.2em] w-full justify-between hover:bg-muted/20"
                    >
                ...
                <CollapsibleContent className="px-4 pb-4 animate-in fade-in slide-in-from-top-1 duration-200">
                    <div className="space-y-3 pt-2">
                        <div className="flex items-center gap-3 group/item">
                            ...
                            <span className="text-[10px] font-medium text-muted-foreground uppercase tracking-widest opacity-80 group-hover/item:opacity-100 group-hover/item:text-foreground transition-all">
                                Neutral Path
                            </span>
                        </div>
                        <div className="flex items-center gap-3 group/item">
