...
const AGENTS = [
    ...
    },
    {
        ...
        category: 'Research',
        description:
            'Multi-source research aggregation with citation tracking.',
        icon: BookOpenIcon,
        popular: true,
    },
    {
        ...
        category: 'Financial',
        description:
            'Real-time stock data, technical analysis, and market insights.',
        icon: TrendingUpIcon,
        popular: true,
    },
    {
    ...
    },
    {
        ...
        category: 'Content',
        description:
            'Polish and refine content with grammar and style improvements.',
        icon: FileTextIcon,
        popular: false,
    },
    {
