...
import { AnimatedCircuitGrid } from '@/app/components/gsap/svg-suite'

const EXAMPLES = [
    {
        title: 'Simple Chat Agent',
        description:
            'A basic conversational agent with memory and context awareness.',
    ...
    },
    {
        ...
        description:
            'Build a document question-answering system with RAG pipelines.',
    ...
    },
    {
        ...
        description:
            'Coordinate multiple agents to conduct research and synthesize reports.',
    ...
    },
    {
        ...
        description:
            'Analyze stocks and market data using specialized financial tools.',
    ...
    },
    {
        ...
        description:
            'Automated content creation with editor and copywriter agents.',
    ...
    },
    {
        ...
        description:
            'Stream and process data in real-time with agent workflows.',
                    ...
                    {filteredExamples.length > 0 ? (
                        filteredExamples.map((example) => (
                            ...
                            >
                                ...
                                <h2 className="mb-2 text-xl font-bold text-foreground transition-colors duration-200 group-hover:text-primary">
                                    {example.title}
                                </h2>
                        ...
                        <div className="col-span-full rounded-2xl border border-dashed border-border bg-card/60 p-8 text-center">
                            <p className="text-sm text-muted-foreground">
                                No examples found for <strong>{search}</strong>.
