            ...
            {nodes.map((node, i) => (
                <motion.div
                    ...
                    className={cn(
                        ...
                        node.main
                            ? 'size-6 bg-primary shadow-[0_0_30px_rgba(var(--primary),0.6)]'
                            : 'bg-neutral-400'
                    )}
                ...
                >
                    ...
                    {!(node.main ?? false) && (
                        <svg
                            className="absolute top-1/2 left-1/2 w-[500px] h-[500px] pointer-events-none opacity-20 overflow-visible"
                            style={{ transform: 'translate(-50%, -50%)' }}
                        >
                            <line
                                x1="250"
                                y1="250"
                                x2={node.left > '50%' ? '100' : '400'}
                                y2={node.top > '50%' ? '100' : '400'}
                                stroke="white"
                                strokeWidth="1"
                            />
                        </svg>
