...
import { AnimatedFractalBeacon } from '@/app/components/gsap/svg-suite'

const TESTIMONIALS = [
    {
        quote: 'AgentStack transformed our development workflow. We went from concept to production in weeks instead of months. The multi-agent orchestration is exactly what we needed.',
        author: 'Sarah Chen',
        title: 'CTO',
    ...
    {
        quote: 'The multi-agent orchestration is incredible. Our AI agents now collaborate seamlessly, handling complex tasks autonomously. Customer satisfaction improved by 40%.',
    ...
    {
        quote: 'Enterprise-grade observability and security features gave us the confidence to deploy in production. Outstanding framework with excellent documentation.',
        author: 'Emily Watson',
    ...
    {
        quote: 'We replaced 5 different tools with AgentStack. The unified platform approach saves us hours every week and the RAG pipelines are incredibly powerful.',
        author: 'David Kim',
        title: 'Head of AI',
        company: 'FinanceAI',
        avatar: 'DK',
    ...
    {
        quote: 'The developer experience is unmatched. TypeScript-first approach, great docs, and an active community. We onboarded our entire team in just two days.',
        author: 'Lisa Park',
    ...
    {
        quote: "From research to report generation, AgentStack handles our entire content pipeline. We've increased output by 3x while maintaining quality standards.",
                ...
                >
                    {TESTIMONIALS.slice(0, 6).map((testimonial, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className={`card-3d group rounded-2xl border border-border bg-card p-6 shadow-sm transition-all duration-300 ease-spring hover:border-primary/30 hover:shadow-lg hover:-translate-y-1 cursor-pointer ${
                                index === activeIndex
