...
export function Navbar() {
    ...
    const docsLinks = [
        { href: '/docs', label: 'All Docs', desc: 'Full documentation' },
        {
            ...
            desc: 'Quick start and tutorials',
        },
        { href: '/docs/ai-sdk', label: 'AI SDK', desc: 'AI SDK integration' },
        {
            href: '/docs/components',
            label: 'Components',
            desc: 'UI components & patterns',
        },
        {
        ...
        },
        {
            ...
            label: 'Core concepts',
            desc: 'Architecture & concepts',
        },
        {
            href: '/docs/prompts/kiro-lite',
            label: 'Prompts',
            desc: 'Prompt patterns',
        },
        {
            href: '/docs/rag',
            label: 'RAG',
        ...
        {
            href: '/docs/runtime-context',
            label: 'Runtime context',
            desc: 'RuntimeContext patterns',
        },
        {
            href: '/docs/security',
            label: 'Security',
                                ...
                                <NavigationMenuContent>
                                    <div className="flex flex-col md:flex-row gap-8 p-6 min-w-max">
                                        <div className="flex flex-col gap-3 w-64">
                                            ...
                                            <Link
                                                href="/chat"
                                                className={`flex items-center gap-3 rounded-sm p-2 text-sm ${pathname === '/chat' ? 'bg-primary/10 shadow-sm' : 'hover:bg-primary/5'}`}
                                            >
                                                <svg
                                        ...
                                        <div className="flex flex-col gap-2 w-56">
                                            ...
                                            {docsLinks.map((dl) => (
                                                ...
                                                >
                                                    <Link
                                                        href={dl.href}
                                                        className={`flex flex-col gap-0 p-2 rounded-sm text-sm ${pathname === dl.href ? 'bg-muted/10 shadow-sm' : 'hover:bg-muted/5'}`}
                                                    >
                                                        <span className="font-medium">
                                                            {dl.label}
                                                        </span>
                                            ...
                                            <NavigationMenuLink asChild>
                                                <Link
                                                    href="/pricing"
                                                    className={`flex items-center gap-3 rounded-sm p-2 text-sm ${pathname === '/pricing' ? 'bg-muted/10 shadow-sm' : 'hover:bg-muted/5'}`}
                                                >
                                                    <div>
                                                        <div className="font-medium">
                                                            Pricing
            ...
            <AnimatePresence>
                {mobileOpen && (
                    ...
                    >
                        ...
                        <Link
                            href="/chat"
                            className={`flex items-center gap-4 p-3 rounded-xl hover:bg-primary/5 transition-colors group ${pathname === '/chat' ? 'bg-primary/10' : ''}`}
                            onClick={() => setMobileOpen(false)}
                        >
                            <div
                                className={`flex size-10 items-center justify-center rounded-lg transition-colors ${pathname === '/chat' ? 'bg-primary text-primary-foreground' : 'bg-primary/10 text-primary'} group-hover:bg-primary group-hover:text-primary-foreground`}
                            >
                                <svg
                                    className="size-5"
                                    viewBox="0 0 24 24"
