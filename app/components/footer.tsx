...
const SOCIAL_LINKS = [
    ...
    {
        name: 'Twitter',
        href: 'https://twitter.com/agentstack',
        icon: TwitterIcon,
    },
    {
        name: 'Discord',
        href: 'https://discord.gg/agentstack',
        icon: DiscordIcon,
    },
    {
        name: 'LinkedIn',
        href: 'https://linkedin.com/company/agentstack',
        icon: LinkedInIcon,
    },
    {
        name: 'YouTube',
        href: 'https://youtube.com/@agentstack',
        icon: YouTubeIcon,
    },
]
...
export function Footer() {
    ...
    const handleSubscribe = async (e: SubmitEvent<HTMLFormElement>) => {
        e.preventDefault()
        if (!email) {
            return
        }
                ...
                <div className="container mx-auto px-4 py-12">
                    <div className="mx-auto max-w-2xl text-center">
                        ...
                        <p className="mb-6 text-muted-foreground">
                            Get the latest updates on new features, best
                ...
                <div className="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-6">
                    ...
                    <div className="col-span-2 md:col-span-3 lg:col-span-2">
                        ...
                        <p className="mt-4 max-w-xs text-muted-foreground leading-relaxed">
                            Production-grade multi-agent framework for building
                            AI applications at scale. Open source,
                            enterprise-ready.
                        </p>
