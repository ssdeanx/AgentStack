...
export const GOOGLE_MODELS: ModelConfig[] = [
  ...
  },
  {
    ...
    name: "Gemini 2.5 Flash Preview (Sep 09 2025)",
    provider: "google",
    contextWindow: 1048576,
    capabilities: ["chat", "reasoning", "vision", "code"],
  ...
  },
  {
    ...
    name: "Gemini 2.5 Flash Lite Preview (Jun 17 2025)",
    provider: "google",
    contextWindow: 1048576,
    capabilities: ["chat", "vision", "code"],
    pricing: { input: 0.10, output: 0.40 },
  ...
  },
  {
    ...
    name: "Gemini 2.5 Flash Preview (Apr 17 2025)",
    provider: "google",
    contextWindow: 1048576,
    capabilities: ["chat", "reasoning", "vision", "code"],
  ...
  },
  {
    ...
    name: "Gemini 2.5 Flash Preview (May 20 2025)",
    provider: "google",
    contextWindow: 1048576,
    capabilities: ["chat", "reasoning", "vision", "code"],
    pricing: { input: 0.15, output: 0.60 },
  ...
  },
  {
    ...
    name: "Gemini 2.5 Pro Preview (May 06 2025)",
    provider: "google",
    contextWindow: 1048576,
    capabilities: ["chat", "reasoning", "vision", "code"],
    pricing: { input: 1.00, output: 10.00 },
