...
export function AgentWebPreview({
    ...
    const codeLanguage = (preview.language ??
        (preview.html ? 'html' : 'tsx')) as BundledLanguage
    ...
    return (
        <Card
            className={`overflow-hidden ${isFullscreen ? 'fixed inset-4 z-50 shadow-2xl' : ''}`}
        >
