...
export const queryKeys = {
    ...
    telemetry: (params?: Record<string, unknown>) =>
        ['telemetry', params] as const,
...
// Agents Queries
export function useAgentsQuery(opts?: {
    page?: number
    perPage?: number
    ...
    return useQuery({
        ...
        queryFn: async (): Promise<Agent | null> => {
            ...
            if (detModelId !== undefined && detModelId !== null) {
                ...
                detModelField !== null &&
                typeof (detModelField as Record<string, unknown>).name ===
                    'string'
            ) {
                ...
                tools: Array.isArray(det.tools)
                    ? (det.tools as unknown[]).map((t) => {
                          ...
                          if (typeof t === 'object' && t !== null) {
                              ...
                              return {
                                  id: (tv.id as string) ?? '',
                                  name: tv.name as string | undefined,
                              }
                          }
                          return { id: String(t), name: String(t) }
                      })
                    : Object.entries(
                          (det.tools ?? {}) as Record<string, unknown>
                      ).map(([id, val]) => ({
                          id,
                          name:
...
export function useWorkflowsQuery(opts?: { page?: number; perPage?: number }) {
    return useQuery({
        ...
        queryFn: async (): Promise<Workflow[]> => {
            ...
            const records =
                (data as { workflows?: Record<string, Workflow> }).workflows ??
                (data as Record<string, Workflow>)
            return Object.entries(records).map(([id, wf]) => ({
                id,
                name: (wf as Record<string, unknown>).name as
                    | string
                    | undefined,
                description: (wf as Record<string, unknown>).description as
                    | string
                    | undefined,
            })) as Workflow[]
        },
        ...
        queryFn: async (): Promise<Workflow | null> => {
            ...
            return {
                ...
                steps: Array.isArray(details.steps)
                    ? (details.steps as unknown[]).map((s) => ({
                    ...
                    : Object.entries(details.steps ?? {}).map(
                          ([stepId, step]) => ({
                              id: stepId,
                              name: (step as Record<string, unknown>).name as
                                  | string
                                  | undefined,
                              description: (step as Record<string, unknown>)
                                  .description as string | undefined,
                          })
                      ),
            } as Workflow
...
export function useToolsQuery(opts?: { page?: number; perPage?: number }) {
    return useQuery({
        ...
        queryFn: async (): Promise<Tool[]> => {
            ...
            const records =
                (data as { tools?: Record<string, Tool> }).tools ??
                (data as Record<string, Tool>)
            return Object.entries(records).map(([toolId, tool]) => ({
                id: toolId,
                name:
                    ((tool as Record<string, unknown>).name as
                        | string
                        | undefined) ?? toolId,
                description: (tool as Record<string, unknown>).description as
                    | string
                    | undefined,
            })) as Tool[]
        },
...
export function useTracesQuery(params?: {
    ...
    return useQuery({
        ...
        queryFn: async () => {
            const result = await getTracesTyped({
                page: params?.page,
...
export function useMemoryThreadsQuery(
    ...
    return useQuery({
        ...
        queryFn: async (): Promise<MemoryThread[]> => {
            const threads = await listMemoryThreadsTyped(
                resourceId,
                agentId,
                opts
            )
...
export function useMemoryMessagesQuery(
    ...
    return useQuery({
        ...
        queryFn: async (): Promise<Message[]> => {
            ...
            const result = await getThreadMessagesTyped(threadId, {
                page: 1,
                perPage: limit,
            })
...
export function useLogsQuery(params?: {
    ...
    return useQuery({
        ...
        queryFn: async () => {
            const data = await listLogsTypedPaged({
...
export function useVectorUpsertMutation() {
    return useMutation({
        mutationFn: async ({
            ...
            const upsertParams = params as unknown as Parameters<
                typeof vector.upsert
            >[0]
    ...
    return useMutation({
        mutationFn: async ({
            ...
            const res = await fetch(
                `${base.replace(/\/$/, '')}/api/vectors/${encodeURIComponent(vectorName)}/delete`,
                {
                    method: 'POST',
...
export function useVectorDetailsQuery(
    vectorName: string,
